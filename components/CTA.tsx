...
export default function CTA() {
  return (
    <div className={"bg-muted"} id={"contact"}>
      <div
        className={
          "flex fle-col items-center min-h-[calc(100vh-80px)] max-w-[1200] mx-auto py-16 sm:py-32 px-4"
        }
      >
        <div>
          ...
          <p className={"text-muted-foreground"}>
            ...
            confidence. Whether you have a loose concept or a fully formed plan,
            I&apos;ll guide you through the path to launch, one step at a time.
          </p>
